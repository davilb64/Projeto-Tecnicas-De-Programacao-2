...
public class Usuario implements UserDetails {
   ...
   *
   * <p>Assertiva de entrada: email não nulo, formato válido, único no sistema,
   ...
   * (que é garantido de não ser nulo), garantimos compatibilidade nativa
   * com os filtros de segurança.
   */
  @Override
   ...
   *
   * <p><b>Assertiva de saída:</b> retorna o val{@code email} (satisfazendo o requisito EU002).
   */
  @Override
