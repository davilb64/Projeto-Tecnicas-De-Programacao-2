...
public interface EstabelecimentoRepository extends JpaRepository<Estabelecimento, Long> {
   ...
   * apenas parte do nome para auditoria.
   * O retorno é sempre uma lista, satisfazendo a assertiva de saída.
   *
   ...
   * Isso impede o vazamento de dados de sugestões
   * não auditadas na barra de busca do usuário comum.
   *
