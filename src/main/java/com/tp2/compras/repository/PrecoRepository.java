 ...
 *   <li>EU010 - Eu como sistema quero cruzar os preços
 *   informados para comparar o valor das listas.</li>
 * </ul>
 */
@Repository
public interface PrecoRepository extends JpaRepository<Preco, Long> {
  ...
  /**
   * Busca o registro de preço MAIS RECENTE de uma variação
   * específica dentro de um mercado específico.
   ...
   *
   * <p><b>Assertiva de saída:</b>
   * Optional contendo o Preco mais recente se existir; Optional empty caso contrário.
   *
   ...
   * um gráfico de variação de preços no futuro (inflação do produto).
   *
   * <p><b>Assertiva de entrada:</b> variacaoId e estabelecimentoId não nulos.
   *
   * <p><b>Assertiva de saída:</b> Lista de Precos ordenada
   * por data; lista vazia se nunca foi registrado.
   *
   * @param variacaoId ID da variação do produto
   * @param estabelecimentoId ID do supermercado
   ...
   */
  List<Preco>
      findByVariacaoIdAndEstabelecimentoIdOrderByDataRegistroDesc(Long variacaoId,
      Long estabelecimentoId);

  /**
   * Query customizada (JPQL) para buscar os preços
   * mais recentes de uma LISTA inteira em um mercado.
   * Otimização extrema para a EU010: em vez de fazer
   * um SELECT (findFirst) para cada item da lista,
   ...
   *
   * <p><b>Assertiva de saída:</b>
   * Lista contendo apenas o Preco mais recente de cada variação solicitada.
   *
   * <p><b>Argumentação da corretude:</b>
