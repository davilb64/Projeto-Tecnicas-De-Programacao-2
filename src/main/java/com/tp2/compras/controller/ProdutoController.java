...
public class ProdutoController {
   ...
   *
   * <p><b>Assertiva de entrada:</b> dto não nulo
   * e validado conforme restrições de ProdutoCadastroDTO.
   *
  ...
  /**
   * Endpoint para buscar produto (GET).
   **/
  @GetMapping("/{id}")
  ...
  /**
   * Endpoint para atualizar produto (PUT).
   **/
  @PutMapping("/{id}")
   ...
   *
   * <p><b>Assertiva de entrada:</b> id do produto não nulo e
   * string de status válida (APROVADO, REJEITADO).
   *
  ...
  /**
   * Endpoint para deletar produto (DELETE).
   **/
  @DeleteMapping("/{id}")
