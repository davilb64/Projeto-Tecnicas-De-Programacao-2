...
public class UsuarioService {
   ...
   * no sistema garantindo a criptografia dos dados de acesso.
   *
   ...
   * <ul>
   * <li>Retorna a entidade {@link Usuario} devidamente
   * persistida com a alocação de ID gerado.</li>
   * <li>A senha em texto plano é destruída e armazenada apenas
   * em formato Hash irreversível (BCrypt).</li>
   * <li>O papel de acesso (Role) é definido estritamente
   * como {@code Papel.USUARIO} por padrão estrutural.</li>
   * </ul>
   *
   ...
   * @throws EmailJaCadastradoException se houver violação da regra de negócio estrutural.
   */
  @Transactional
   ...
   * <p>Pós-condições (Assertivas de Saída):
   * <ul>
   * <li>Retorna {@code true} exclusivamente se as credenciais
   * forem válidas e a comparação matemática do hash corresponder.</li>
   * </ul>
   *
   * @param dto objeto envelopado contendo as credenciais de
   *            acesso (e-mail e senha) fornecidas pelo usuário.
   * @return {@code true} caso a autenticação no banco seja bem-sucedida.
   * @throws CredenciaisInvalidasException se o e-mail não for encontrado ou
  ...
  /**
   * Busca usuários pendentes de aprovação para adm.
   */
