...
/**
 * Métodos de Variação de Produto.
 */
@Service
...
public class VariacaoProdutoService {
  ...
  /**
   * Atualiza variações de produtos.
   */
  @Transactional
    ...
    if (dto.descricao() != null && !dto.descricao().isBlank()) {
      variacao.setDescricao(dto.descricao());
    }
    if (dto.peso() != null) {
      variacao.setPeso(dto.peso());
    }
    if (dto.unidade() != null) {
      variacao.setUnidade(dto.unidade());
    }
